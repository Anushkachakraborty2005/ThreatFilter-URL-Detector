...
(1)Create a file named .env in the root directory of your project (the same folder as app.py).

(2)Add your VirusTotal API key to this .env file in the following format:
```bash
