...
Security Note: The .env file is intentionally excluded from version control (.gitignore ensures this [cite: image_26ce7c.png]) to protect your sensitive API key.
